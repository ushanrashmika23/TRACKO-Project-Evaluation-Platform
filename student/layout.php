...
<head>
    ...
    <title>TRACKO - Student Dashboard</title>
    ...
    <div id="main-content" class="main-content">
        ...
        <main class="page-content">
            ...
            <div class="content-container">
                ...
                $allowed_pages = ['dashboard', 'submissions', 'profile'];
        ...
        function loadPage(page) {
            fetch(page + '.php')
                ...
                .then(html => {
                    ...
                    document.getElementById('navbar-title').textContent = titles[page] || 'Student Portal';
