...
<head>
    ...
    <title>TRACKO - Supervisor Dashboard</title>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    <a href="#" data-page="evaluations"
                        class="sidebar-link <?php echo $current_page === 'evaluations' ? 'active' : ''; ?>">
    ...
    <div id="main-content" class="main-content">
        ...
        <header class="navbar">
            <div class="navbar-left">
                ...
                <h1 class="navbar-title" id="navbar-title">
                    ...
                    echo $page_titles[$current_page] ?? 'Supervisor Portal';
                    ?>
                </h1>
            </div>
        ...
        <main class="page-content">
            ...
            <div class="content-container">
                ...
                $allowed_pages = ['dashboard', 'evaluations', 'projects', 'students', 'profile'];
        ...
        function loadPage(page) {
            fetch(page + '.php')
                ...
                .then(html => {
                    ...
                    document.getElementById('navbar-title').textContent = titles[page] || 'Supervisor Portal';
